...
export function truncarIp(ip: string | null | undefined): string | null {
  ...
  if (limpia.includes('.')) return truncarIpv4(limpia);
  if (limpia.includes(':')) return truncarIpv6(limpia);
  return null;
}

function truncarIpv4(ip: string): string | null {
...
function truncarIpv6(ip: string): string | null {
